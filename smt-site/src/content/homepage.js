export const homepageContent = {
  ...
  aboutPage: {
    heading: "About SMT",
    title: "Healthcare-Focused Ergonomic Mounting Specialists",
    text: "SMT helps hospitals, clinics, and professional offices plan and deploy ergonomic mounting systems that improve workspace safety, usability, and long-term reliability. We provide product selection, site evaluation, certified installation, cable management, and preventive maintenance for monitor arms, wall stations, CPU holders, and related mounting hardware.",
    strengths: [
      "Authorized reseller for leading ergonomic mounting brands",
      "Certified installers experienced in active care environments",
      "Infection-control-conscious installation planning and execution",
      "Clear project scope, scheduling, and on-site coordination",
      "Bi-annual preventive maintenance options for long-term uptime",
      "Responsive support for upgrades, repairs, and expansion phases",
    ],
    missionHeading: "Our Mission",
    missionText:
      "Deliver safe, practical, and durable ergonomic mounting environments that support clinicians, protect patient-care spaces, and improve day-to-day workflow.",
    missionPoints: [
      "Improve caregiver comfort through ergonomic positioning and adjustability",
      "Reduce workstation clutter with secure mounting and organized cable routing",
      "Support infection-control priorities during installs in sensitive areas",
    ],
    approachEyebrow: "Work With SMT",
    approachTitle: "Plan, Install, Maintain",
    approachText:
      "From first walkthrough to long-term service, SMT manages the full lifecycle of mounting solutions with a structured and accountable process.",
    approachPoints: [
      "Evaluate site conditions, user needs, and hardware compatibility",
      "Recommend mounting options that fit space, workflow, and budget",
      "Install with trained teams and healthcare-aware safety practices",
      "Provide preventive maintenance and ongoing service support",
    ],
    image: "/images/smt/flameonepage-img-500x500-01.jpg",
    video: "/videos/Untitled video (4).mp4",
  },
  products: {
    heading: "Products",
    subtitle:
      "Distributor/Reseller/Installer - We provide and install Humanscale, Capsa, Ergotron and other custom suitable ergonomic mounting solutions.",
    items: [
      {
        heading: "Wall Mount",
  ...
  services: {
    heading: "Services",
    intro:
      "There are many types of mounting solutions that are suitable to mount your monitors, keyboards, CPU, printers which will save space on your work surface and also increase your comfortable eye level to prevent neck strain, and to move it whenever you feel to prevent yourself from staying in the same position for a long time. Besides moving them to the positions you like, an articulate arm eliminates clutter by providing you more desk space and manage all loose cables on the floor and desk.",
    ...
    detailSections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Tighten tension on mounts",
          "Adjust all counterbalance parts as needed",
          "Make sure all parts are tightened and secure",
          "Wire management",
          "Free replacement if mount cannot be fixed",
        ],
        footnote:
          "Our installers have been trained in infection control procedures and we create an infection control plan for each installation area. We use small vacuum units with HEPA filters to eliminate airborne particles as well as tents in patients care areas to prevent any dust.",
        image: "/images/smt/flameonepage-img-970x647-10.jpg",
      },
    ],
  },
  benefits: {
